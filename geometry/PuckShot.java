...
/*
	public static void main(String[] args) {
		...
		//double res = obj.caromAngle(2833, new int[]{1500, 1580}, new int[]{1730, 1730});
		//assertEquals(47.022170720170784, res, res * 1e-9);
		//double res = obj.caromAngle(2833, new int[]{2690,  2676}, new int[]{500, 500});
		//assertEquals(-1.0, res, 1e-9);
		double res = obj.caromAngle(
