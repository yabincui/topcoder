...
public class IslandFerriesTest {
  IslandFerries island = new IslandFerries();

  @Test
  public void test() {
    assertArrayEquals(new int[]{5, 7, 5},
      island.costs(new String[]
      { "0-1 0-3", "0-2" },
      new String[]
{ "5 7", "1000 1000", "1000 1000", "1000 1000" }));      
    ...
    { 1,  11,  31,  -1 },
    island.costs(new String[]
{ "0-1 1-2 2-3", "0-1 2-3" }, new String[]
{ "1 10", "20 25", "50 50", "1000 1000", "1000 1000" }));
    assertArrayEquals(new int[]
    { 1,  12,  112 },
    island.costs(new String[]
{ "0-1", "1-0", "0-2", "2-3" }, new String[]
...
{ 170,  160,  155,  173,  145,  150,  158,  168,  153,  145,  162,  88,  162,  86,  163,  159,  153,  150,  104 },
 ...
 "3-12 4-11 10-17 13-12 3-0 3-7 13-0 9-15 10-9 0-10" }, new String[]
